      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        >
          ...
          <div className="relative z-10">
            <span className="inline-block bg-white/20 text-white text-xs font-bold px-4 py-1.5 rounded-full mb-6">
              Mulai Sekarang
            </span>
            <h2 className="text-3xl md:text-5xl font-extrabold text-white mb-6 leading-tight">
              Siap Mulai Karier IT-mu?
            </h2>
            <p className="text-lg text-white/80 mb-10 max-w-2xl mx-auto leading-relaxed">
              Jangan tunda lagi. Jadilah bagian dari ribuan alumni sukses yang telah membangun masa depan bersama E17 Course.
            </p>
