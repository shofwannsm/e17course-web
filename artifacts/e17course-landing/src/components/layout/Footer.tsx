...
const T = {
  id: {
    ...
    address: 'Jl. Basoka Raya No.8, Joglo, \nKembangan, Kota Jakarta Barat, \nDKI Jakarta 11640',
    ...
    programLinks: [
      ...
      { label: 'Sertifikasi', href: '/program#sertifikasi' },
      // { label: 'E-learning Interaktif', href: '/program' },
      // { label: 'Review CV AI', href: '#' },
      { label: 'Corporate Training', href: '/program#corporate' },
    ],
  ...
  en: {
    ...
    programLinks: [
      ...
      { label: 'Certification', href: '/program#sertifikasi' },
